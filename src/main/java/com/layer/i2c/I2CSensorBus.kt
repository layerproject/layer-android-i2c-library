...
class I2CSensorBus(val busPath: String) {
    ...
    companion object {
        ...
        fun initPorts():MutableList<I2CSensorBus> {
            ...
            val usesPort1 = listOf("3cc0ef17", "51eaaebb", "6268fcd3", "6aceb0a1", "6b52867a", "8b11ea02", "92cd665f", "122ff29e", "715d8296", "b89d02a6", "c10f6a3a", "c1e07642", "e593b0da", "fe5064cd" )
        ...
        withContext(context) {
            try {
                ...
                if (scanResult.detectedDevices.isNotEmpty()) {
                    ...
                    val mux = multiplexer
                    if (mux != null && (mux.isReady() || mux.connect())) {
                        val allChannels = mux.scanAllChannels()
